...
**Where can I enable the SSO subscription?  applicable to Team owners only(soon).**
...
Step 3: Click on the “**Invite**” button under the “**Neuro settings**” tab.
...
4. Automatic redirection:
   ...
   User will automatically land on the Neuro Team workspace upon successful SSO authentication.
