...
<CardGroup>
  <Card title="Documentation" icon="book" href="https://docs.neuroai.com">
    Browse comprehensive guides and tutorials
  </Card>
  <Card title="API Status" icon="signal" href="https://status.neuroai.com">
    Check real-time API availability
  </Card>
  <Card title="Support" icon="headset" href="https://support.neuroai.com">
    Contact our support team
  </Card>
  <Card title="Community" icon="comments" href="https://community.neuroai.com">
