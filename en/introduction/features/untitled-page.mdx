...
- Supports context windows of more than **128K tokens**
...
- **Docker-based isolation** with only 5% overhead
- **KV-cache optimization** for 60% cache hit rates
- **Support for 500 simultaneous sandbox environments**
- Integrated tools: web browser, code editor, file system
...
- 200+ integrations with external services
...
<Info>
  **Measurable performance indicators:**
  ...
  - **99.1% audit accuracy** in financial tasks
  - **96.8% on FinQA benchmark**
  - Context windows of more than **128K tokens**
  - **60% cache hit rates** with KV-cache optimization
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Agents" icon="robot" href="/introduction/features/agents/overview">
  ...
  <Card title="General settings" icon="gear" href="/introduction/general-settings/settings">
    Configure your Neuro AI workspace
  </Card>
</CardGroup>